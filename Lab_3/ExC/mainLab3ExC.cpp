...
template<typename LT_Key, typename LT_Datum> void print(LookupTable<LT_Key,LT_Datum>& lt);


template<typename LT_Key, typename LT_Datum> void try_to_find(LookupTable<LT_Key,LT_Datum>& lt, LT_Key key);
