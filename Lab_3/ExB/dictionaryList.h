...
class Node {
  ...
  //friend std::ostream& operator <<(ostream &os, DictionaryList &dl);
//must fix this later  
private:
  Key keyM;
  Datum datumM;
...
private:
  ...
  std::ostream& operator <<(ostream &os, const Mystring &cursorM);
  std::ostream& operator <<(ostream &os, DictionaryList &dl);
  //std::ostream& operator <<(ostream &os, String & str);
