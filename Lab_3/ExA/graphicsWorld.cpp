...
void GraphicsWorld::run(){
	...
	Point n (6,8);
	n.setx(9);
	cout << "\nExpected to dispalythe distance between m and n is: 3";
	...
	Square s(5, 7, 12, "SQUARE -S");															//doesnt match with current Square constructor
	s.display();
	cout << "End of Square test" << endl;
#endif             // end of block to test Square
	
#if 1		// Change 0 to 1 to test Rectangle
	cout<< "\nTestingFunctions in class Rectangle:";
	Rectangle a(5, 7, 12, 15, "RECTANGLE A");													//doesnt match with current Rectable constructor
	a.display();
	...
	Rectangle rec3(a);																																												//might need to add copy constructor for this one
	rec3.display();
	a.set_side_b(300);
	a.set_side_b(400);
	...
	cout << "\nthe perimeter of " << sh[2]->getName() << " is: " << sh[2]->perimeter();
	sh[3]->display();
